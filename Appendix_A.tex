...
The architecture used in the example is a 2 processor (4 cores each) with L3 chache shared among the cores. (\textbf{Figure} \ref{fig:AppAArch})


\begin{figurehere}
  {\centering
 \includegraphics[width=12cm,height=4cm]{./eps/ExampleArchitecture_A.eps}
