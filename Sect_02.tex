...
\begin{enumerate}
	...
	\item Query the hardware capability (Number of devices available, number of processing units, buffers size...)
	\item Obtain hardware resources
	\item Initialize memory objects
	\item Create kernels
	\item Issue orders to kernels (Launch, synchronization, memory management)
	\item Retrieve output data from kernels
	\item Manage errors
	\item Release of hardware resources, deallocation of memory, and final cleanup.
\end{enumerate}
