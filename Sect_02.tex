...
Another interesting feature that allow even more flexibility and control over the hardware is that device fission allows sub-devices to be further partitioned and therefore to create a tree-like structure like the one shown in \textbf{Figure \ref{fig:subdevicestree}}:
